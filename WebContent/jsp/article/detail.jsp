	...
	<div class="detail-box-1 absolute-center absolute-middle">
		...
		<div class="data-box-1 ">
			...
			<% if ( (boolean)article.getExtra().get("modifyAvailable"))  { %>
				<a 	href="${pageContext.request.contextPath}/s/article/modify?id=<%=article.getId()%>"
		...
		<div class="editor-box">
			...
			<div class="delete-button">
				<% if ( (boolean)article.getExtra().get("deleteAvailable"))  { %>
					<button type="submit"  onclick="if (confirm('삭제하시겠습니까?') == false ) return false; location.href='doDelete?id=${param.id}'" 	style="position: absolute; left:55%; top: 30%;">
					게시물 삭제 
					</button>
				<%} %>
